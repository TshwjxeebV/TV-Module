...
document.addEventListener("DOMContentLoaded", () => {
    ...
    document.addEventListener('keydown', (e) => {
        ...
        if (e.key === 'ArrowRight') {
            const controller = window.slideControllers[currentGlobalSlide];
            if (controller && controller.nextStep && controller.nextStep()) { uiSound.playStepForward(); return; }
            if (currentGlobalSlide < totalSlides - 1 && slideCompletion[currentGlobalSlide] && currentGlobalSlide !== 7 && currentGlobalSlide !== 8 && currentGlobalSlide !== 9) goToSlide(currentGlobalSlide + 1);
    ...
    const evalData = {
        oled: {
            ...
            sunroom: { title: "POOR FIT", text: "Glass reflects bright light like a mirror, crushing dark details. High burn-in risk if left on static cartoons all day.", color: "#ff3b30" },
            garage: { title: "WASTED POTENTIAL", text: "Overkill for a casual environment. High risk of elemental damage and unnecessary cost.", color: "#FFD60A" }
        },
        miniled: {
        ...
        qled: {
            ...
            garage: { title: "EXCELLENT FIT", text: "A bright, vibrant option that is relatively cost-effective for a large space.", color: "var(--accent)" }
        },
        led: {
            ...
            garage: { title: "PERFECT FIT", text: "Cheap, reliable, and versatile. Ideal for casual viewing where picture perfection isn't required.", color: "var(--accent)" }
        }
    };
